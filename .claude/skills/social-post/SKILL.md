...
- Read the matching structure in `/Users/apple/Desktop/onam-studio/studio/content-types/<type>.md` and the rules in
  `social-posts/README.md`.
- Fill a brief from `/Users/apple/Desktop/onam-studio/studio/briefs/TEMPLATE.md`. Facts ONLY from repo sources
...
**Read `/Users/apple/Desktop/onam-studio/doctrine/STORYTELLING.md` FIRST** (5-beat arc, emotional core, VO pacing,
slide rules) **and `/Users/apple/Desktop/onam-studio/doctrine/FILMMAKING.md` for videos** (7-phase production process,
...
```bash
/Users/apple/Desktop/onam-studio/assets/make-media.sh story social-posts/<folder>/storyboard.txt social-posts/<folder>
...
```bash
/Users/apple/Desktop/onam-studio/assets/make-media.sh annotate public/screenshots/<s>.png <folder>/images/slide-N.png "x,y,w,h" "Caption" [--zoom]
```
...
/Users/apple/Desktop/onam-studio/assets/make-media.sh card "Line one" "Line two" "Supporting sentence" social-posts/<folder>
...
/Users/apple/Desktop/onam-studio/assets/make-media.sh video /Users/apple/Desktop/onam-studio/footage/<clip>.mp4 "Line one" "Line two" "Sub" social-posts/<folder> \
...
playbook sections now in /Users/apple/Desktop/onam-studio/doctrine/). Captions: ≤42 chars, times relative to the raw clip,
...
`/Users/apple/Desktop/onam-studio/footage/` (attack-path, onboarding, full demo — pick the one matching the topic).
...
```bash
/Users/apple/Desktop/onam-studio/assets/qa.sh all <pkg> | tee <pkg>/qa.txt
```
...
Produce in `/Users/apple/Desktop/onam-studio/productions/YYYY-MM-DD-<slug>/` (run make-media.sh from /Users/apple/Desktop/onam-studio so footage/ paths resolve); after approval copy FINALS ONLY to `social-posts/<slug>/` in the website repo:
